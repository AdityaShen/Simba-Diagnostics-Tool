/**
 * @file state.js
 * @description Centralized application state for Simba client UI.
 * @author Aditya Shen
 * @copyright Simba3, AdityaShen
 * @date 2025-09-10
 *
 * Contains the globalState object for all runtime state and the resetStreamRelatedState function for stream cleanup.
 * Only important functions are documented for clarity and maintainability.
 */
...
/**
 * Resets all stream-related state in the globalState object.
 * Used when stopping or restarting a stream to ensure clean state.
 */
