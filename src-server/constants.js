/**
 * @file constants.js
 * @description Centralized constants for Simba backend modules, including ports, paths, codec info, and message types.
 * @module constants
 * @author Simba Team
 * @copyright Simba (c) 2025
 * @license MIT
 *
 * Provides configuration, protocol, and codec constants for backend services.
 */
...
const SERVER_JAR_PATH = path.resolve(
    __dirname,
    "../public/vendor/Genymobile/scrcpy-server/scrcpy-server-v3.2",
);
...
const VIDEO_METADATA_LENGTH_H264 = 12;
const AUDIO_METADATA_LENGTH_AAC = 4;
...
module.exports = {
    ...
    BASE_SCRCPY_OPTIONS,
    DEVICE_NAME_LENGTH,
    VIDEO_METADATA_LENGTH_H264,
    AUDIO_METADATA_LENGTH_AAC,
